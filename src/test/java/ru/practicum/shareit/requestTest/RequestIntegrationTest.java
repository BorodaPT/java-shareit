...
public class RequestIntegrationTest {
    ...
    void getUserRequests() {
        ...
        assertThat(itemDTOList.get(0).getId(), equalTo(itemRequestDto3.getId()));
        assertThat(itemDTOList.get(1).getId(), equalTo(itemRequestDto2.getId()));
        assertThat(itemDTOList.get(2).getId(), equalTo(itemRequestDto1.getId()));
        assertThat(itemDTOList.get(2).getItems().get(0).getId(), equalTo(item1.getId()));
        assertThat(itemDTOList.get(2).getItems().get(0).getDescription(), equalTo(item1.getDescription()));
    ...
    void getAllUsersRequestsWithPage() {
        ...
        assertThat(itemDTOList.get(0).getId(), equalTo(itemRequestDto3.getId()));
        assertThat(itemDTOList.get(0).getItems().get(0).getId(), equalTo(item2.getId()));
        assertThat(itemDTOList.get(0).getItems().get(0).getDescription(), equalTo(item2.getDescription()));
    }
